...
const formatAlert = (id, body, title, confirmButtonText, actionButtonText) => {
...
const openAlert = (alertConfig) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (timer) {
        timeout[id] = setTimeout(() => __awaiter(void 0, void 0, void 0, function* () {
            yield closeAlert(id);
        }), timer);
    }
    ...
    if (actionButton) {
        actionButton.addEventListener('click', () => __awaiter(void 0, void 0, void 0, function* () {
            yield closeAlert(id);
            if (actionCallback) {
                actionCallback();
            }
